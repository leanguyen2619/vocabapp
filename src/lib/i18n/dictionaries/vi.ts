const vi = {
  ...
  admin: {
    accounts: {
      ...
      deleteConfirmDesc: "Xóa tài khoản {name}? Toàn bộ tiến độ học tập, bài đã giao và lịch sử liên quan sẽ bị xóa vĩnh viễn. Hành động này không thể hoàn tác.",
      deleteSuccess: "Đã xóa tài khoản {name}.",
    ...
    classes: {
      ...
      rosterButton: "Học viên",
      rosterTitle: "Học viên lớp {name}",
      rosterDesc: "Thêm hoặc xóa học viên khỏi lớp này.",
      rosterEmpty: "Lớp này chưa có học viên nào.",
      addStudentPlaceholder: "Chọn học viên để thêm...",
      addStudentButton: "Thêm",
      addStudentSuccess: "Đã thêm {name} vào lớp.",
      noAddableStudents: "Không còn học viên nào để thêm.",
      removeStudentSuccess: "Đã xóa {name} khỏi lớp.",
      removeStudentError: "Không thể xóa học viên khỏi lớp, vui lòng thử lại.",
    },
    vocabulary: {
      title: "Từ vựng",
