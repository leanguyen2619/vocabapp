...
const en: Dictionary = {
  ...
  admin: {
    accounts: {
      ...
      deleteConfirmDesc: "Delete account {name}? All of their learning progress, assignments, and related history will be permanently deleted. This action cannot be undone.",
    ...
    classes: {
      ...
      rosterButton: "Students",
      rosterTitle: "{name} roster",
      rosterDesc: "Add or remove students from this class.",
      rosterEmpty: "This class has no students yet.",
      addStudentPlaceholder: "Choose a student to add...",
      addStudentButton: "Add",
      addStudentSuccess: "Added {name} to the class.",
      noAddableStudents: "No more students available to add.",
      removeStudentSuccess: "Removed {name} from the class.",
      removeStudentError: "Could not remove the student from the class, please try again.",
    },
    vocabulary: {
      title: "Vocabulary",
