...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: dict.pageTitles.fillBlank };
}
  ...
  return (
    <div className="flex flex-1 flex-col bg-background">
      <header className="border-b border-border">
        <div className="mx-auto flex w-full max-w-2xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <RandomExerciseButton currentCode="fill_blank" types={exerciseTypes} dict={dict} />
          </div>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-6 py-10 sm:py-16">
        <FillBlankGame questions={questions} dict={dict} />
      </main>
    </div>
  );
}
