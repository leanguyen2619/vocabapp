...
export default function AdminQuestionBankPage() {
  ...
  const [questions, setQuestions] = useState<QuestionWithAnswers[]>(() => [...questionBank]);
  ...
  const handleSetStatus = (q: QuestionWithAnswers, next: QuestionStatus) => {
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {q.status !== "approved" && (
                    <Button
                      ...
                      onClick={() => handleSetStatus(q, "approved")}
                    >
                  ...
                  {q.status !== "rejected" && (
                    <Button
                      ...
                      onClick={() => handleSetStatus(q, "rejected")}
                    >
